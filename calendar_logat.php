    ...
    <body>
        ...
        <section>
            ...
            <div class="pagina">
                <!--HEADER-->
                <div class="meniu">
                    <div class="logo">Finns - Calendar</div>
                        <ul>
                            ...
                            <td>
                                <p class="cuprins">
                                    <b>
                                        ...
                                        Calendar Scoala de Vara "Finns" - Perioada 4-22 Iulie

                                    </b>
                                </p>
                                <img src="imagini/calendar1.png" alt="CalendarPerioadaIulie" class="calendar">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="cuprins">
                                    <b>
                                        Calendar Scoala de Vara "Finns" - Perioada 8-26 August
                                    </b>
                                </p>
                                <img src="imagini/calendar2.png" alt="CalendarPerioadaAugust" class="calendar">
                            </td>
                        </tr>
                        <tr>
                            <td>
